...
extern irqreturn_t px_timer_isr(unsigned int pid, unsigned int tid, unsigned int pc, unsigned int ts);
...
static void set_ccnt_events(struct HSEventConfig *ec, struct pmu_registers_pj4 *pmu_regs)
{
...
struct hs_sampling_op_mach hs_sampling_op_pj4 = 
{
