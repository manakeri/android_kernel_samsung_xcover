...
#ifndef __TIMER_PJ1_H__
#define __TIMER_PJ1_H__
...
#include <mach/irqs.h>
	...
	#define AP_TIMER_BASE(t)     (APB_VIRT_BASE + 0x00014000 + (0x2000 * (t-1))) /* the base address of AP Timer t */
...
#define APBC_TIMERS0_CLK_RST  __PX_REG(APB_CLOCK_UNIT_BASE + 0x0034)            /* Clock/Reset Control Register for Timers 0 */
#define APBC_TIMERS1_CLK_RST  __PX_REG(APB_CLOCK_UNIT_BASE + 0x0044)            /* Clock Reset Control Register for Timers 1 */

/* Application Subsystem Timers 1 interrupt */
#define PX_IRQ_PJ1_TIMER1_1 13
#define PX_IRQ_PJ1_TIMER1_2 14
#define PX_IRQ_PJ1_TIMER1_3 15

/* Application Subsystem Timers 2 interrupt */
#define PX_IRQ_PJ1_TIMER2_1 29
#define PX_IRQ_PJ1_TIMER2_2 30
#define PX_IRQ_PJ1_TIMER2_3 50
 
#endif /* __TIMER_PJ1_H__ */
