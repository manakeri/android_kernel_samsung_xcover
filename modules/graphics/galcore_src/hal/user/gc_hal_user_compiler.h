...
struct _gcATTRIBUTE
{
	...
	/* Special handle mat2/mat2/mat4, */
    /* internal we take them as array of vec2/vec3/vec4. */
    /* we need record it's orginal type which used in glGetActiveAttrib */
	gcSHADER_TYPE				orgType;    
