...
#define gcvSAMPLER_MIN_FILTER_MASK     0x7
#define gcvSAMPLER_MIN_FILTER_SHIFT     0
#define gcvSAMPLER_MAG_FILTER_MASK    0x38
#define gcvSAMPLER_MAG_FILTER_SHIFT    3
#define gcvSAMPLER_WRAPR_MASK               0x40
#define gcvSAMPLER_WRAPR_SHIFT              6
#define gcvSAMPLER_WRAPS_MASK               0x80
#define gcvSAMPLER_WRAPS_SHIFT               7
#define gcvSAMPLER_POW2_MASK                 0x100
#define gcvSAMPLER_POW2_SHIFT                 8

#define TEXTURE_POW2                                     0x22
