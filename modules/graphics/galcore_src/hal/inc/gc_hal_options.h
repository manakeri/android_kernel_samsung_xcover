...
/* Enable DXT COMPRESS internal */
#define MRVL_EANBLE_COMPRESSION_DXT         1

/* Export Compress string for query */
#define MRVL_EXPORT_COMPRESSION_DXT_STRING  0
...
#define MRVL_USE_NEW_SWAP                   1
#else
#define MRVL_USE_NEW_SWAP                   0
#endif
...
/* 
 *  Send HW mask instead of SW mask to gralloc
 */
 #define MRVL_GRALLOC_HW_MASK               1
 
/*
 *  Add not aligned size yuv support in 2d path.
 */
#define MRVL_NOT_ALIGN_YUV_SUPPORT          1

/*
 *  do horizontal resize when convert(FilterBlit) yuv to rgb for normal quality case.
 */
#define MRVL_NORMAL_QUALITY_H_RESIZE        1
...
#define _GC_VERSION_STRING_         "GC Ver0.8.0.4201"
