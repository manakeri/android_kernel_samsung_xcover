...
/** Driver mode WFD bit */
#define DRV_MODE_WFD       MBIT(2)
/** Maximum WFD BSS */
#define MAX_WFD_BSS        1
/** Default WFD BSS */
#define DEF_WFD_BSS        1
...
/** Get data rate */
mlan_status woal_get_data_rate(moal_private * priv, mlan_ds_rate * datarate);
...
#ifdef WRITE_MACADDR
mlan_status woal_write_macaddr(moal_private * priv);
#endif
/*- Add from ASW3 Android project of Samsung Elec. Co. -*/
