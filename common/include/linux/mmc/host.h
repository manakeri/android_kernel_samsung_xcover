...
#define MMC_CAP_DISABLE_BUS_CLK_GATING	(1 << 11)
// start marvell johnryu
/* controller could disable card detection in probe procedure for some devices, eg, for 8787 wifi/bt/fm sdio card */
#define MMC_CAP_DISABLE_PROBE_CDDET	(1 << 12)
// end marvell johnryu
...
#define MMC_BUSRESUME_NEEDS_RESUME	(1 << 1)
	...
	/* --- Pay attention: last is cacheline_aligned ---*/
