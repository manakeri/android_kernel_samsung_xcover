...
struct sdhci_ops {
	...
	unsigned int	(*set_power)(struct sdhci_host *host, unsigned short power);
	int	(*platform_8bit_width)(struct sdhci_host *host, int width);
	void	(*set_con_clock)(struct sdhci_host *host, int clock);
	int	(*ext_cd_status)(struct sdhci_host *host);
};
