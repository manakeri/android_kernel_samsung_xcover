...
struct otg_transceiver {
	...
	/* handle interrupt related to usb otg */
...
#ifdef CONFIG_PLAT_PXA
static inline int otg_disconnect(struct otg_transceiver *otg)
{
	return otg->disconnect(otg);
}

static inline int otg_connect(struct otg_transceiver *otg,
				struct usb_device *udev)
{
	return otg->connect(otg, udev);
}

static inline int otg_host_suspend(struct otg_transceiver *otg)
{
	return otg->host_suspend(otg);
}

static inline int otg_interrupt(struct otg_transceiver *otg)
{
