...
struct usb_function {
	...
	void			(*resume)(struct usb_function *);
		...
		/* index value (bInterfaceNumber) of certain function's
		interface-descriptor  is changed according to function's
		location in USB composite  configuration-descriptor
		(as defined in USB2.0 spec).
		This function will set the first interface index of a
		function according to the currently used composite
		configuration*/
	void			(*set_first_interfrace)(struct usb_function *,
					unsigned);
#endif
