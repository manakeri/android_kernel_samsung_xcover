...
struct v4l2_ioctl_ops {
    ...
    /* Flash handler */
    int (*vidioc_s_flash)(struct file *file, void *fh, struct v4l2_flash *flash);
    int (*vidioc_g_flash)(struct file *file, void *fh, struct v4l2_flash *flash);
    
    /* WhiteBalance handler */
    int (*vidioc_s_wbmode)(struct file *file, void *fh, struct v4l2_wb_mode *wb);
    int (*vidioc_g_wbmode)(struct file *file, void *fh, struct v4l2_wb_mode *wb);
    int (*vidioc_querywbmode)(struct file *file, void *fh, struct v4l2_query_wb_mode *querywb);

    /* EFFECT handler */
    int (*vidioc_s_efx)(struct file *file, void *fh, struct v4l2_efx *efx);
    int (*vidioc_g_efx)(struct file *file, void *fh, struct v4l2_efx *efx);
    int (*vidioc_queryefx)(struct file *file, void *fh, struct v4l2_query_efx *queryefx);
