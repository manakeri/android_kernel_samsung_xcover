...
// xj modify to meet serial queue size 32 for default
...
uint_8  _usb_device_recv_data(void* handle, uint_8 ep_num, uint_8* buf_ptr, uint_32 size, uint_32 real_size);
...
extern void dump_ep_req(int, int);
