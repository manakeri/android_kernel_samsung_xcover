 ...
 */
static struct usb_request *gs_alloc_req(struct usb_ep *ep, unsigned len,
					gfp_t kmalloc_flags)
{
 ...
 */
static int __init gserial_setup(struct usb_gadget *g, unsigned count)
{
	unsigned i;
 ...
 */
static void gserial_cleanup(void)
{
	unsigned i;
	struct gs_port *port;
 ...
 */
static int gserial_connect(struct gserial *gser, u8 port_num)
{
	struct gs_port *port;
	unsigned long flags;
	int status;
