...
.first_size=348*1024*1024,    // it has dependency on h/w 

.first_start_addr=0x82400000, // it has dependency on h/w
...
#if 1 // SEC_GET_LOG //{{ pass platform log (!@hello) to kernel - 2/3
...
#endif // SEC_GET_LOG //}} pass platform log (!@hello) to kernel - 2/3
