...
#define     AXI_LATENCY_TOO_LONGR_IRQ_ENA(irq)	((irq)<<16)
#define     AXI_LATENCY_TOO_LONGR_IRQ_ENA_MASK	0x00010000
...
#define error_irq_imasks(id) (((id) ? (((id) & 1) ? \
	(TV_DMA_FF_UNDERFLOW_ENA_MASK | TV_GRA_FF_UNDERFLOW_ENA_MASK) : \
	(PN2_DMA_FF_UNDERFLOW_ENA_MASK | PN2_GRA_FF_UNDERFLOW_ENA_MASK)) :\
	(DMA_FF_UNDERFLOW_ENA_MASK | GRA_FF_UNDERFLOW_ENA_MASK)) | \
	(AXI_BUS_ERROR_IRQ_ENA_MASK | AXI_LATENCY_TOO_LONGR_IRQ_ENA_MASK))
#define error_imasks (error_irq_imasks(0) | error_irq_imasks(1))
...
#define squln_ctrl(id)	((id) ? (((id) & 1) ? LCD_SQULN2_CTRL : LCD_PN2_SQULN1_CTRL) : LCD_SQULN1_CTRL)
