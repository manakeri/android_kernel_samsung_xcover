...
#define GPIO_TSP_SDA GPIO_I2C0_SDA
#define GPIO_TSP_SCL  GPIO_I2C0_SCL
#define GPIO_TOUCH_EN 125
...
#define MCSDL_CE_SET_HIGH()   	          			gpio_direction_output(TOUCH_EN, 1)
#define MCSDL_CE_SET_LOW()      	        		       gpio_direction_output(TOUCH_EN, 0)
...
#define MCSDL_GPIO_SCL_SET_HIGH()					gpio_direction_output(GPIO_TOUCH_I2C_SCL, 1)
#define MCSDL_GPIO_SCL_SET_LOW()					gpio_direction_output(GPIO_TOUCH_I2C_SCL, 0)

#define MCSDL_GPIO_SDA_SET_HIGH()					gpio_direction_output(GPIO_TOUCH_I2C_SDA, 1)
#define MCSDL_GPIO_SDA_SET_LOW()					gpio_direction_output(GPIO_TOUCH_I2C_SDA, 0)

#define MCSDL_GPIO_SCL_SET_OUTPUT(n)					gpio_direction_output(GPIO_TOUCH_I2C_SCL, n)
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_direction_input(GPIO_TOUCH_I2C_SCL)

#define MCSDL_GPIO_SDA_SET_OUTPUT(n)					gpio_direction_output(GPIO_TOUCH_I2C_SDA, n)
#define MCSDL_GPIO_SDA_SET_INPUT()					gpio_direction_input(GPIO_TOUCH_I2C_SDA)
