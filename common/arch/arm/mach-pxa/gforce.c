/*
 *  linux/arch/arm/mach-pxa/gforce.c
 *
 *  Support for the Marvell Handheld Platform (aka GFORCE)
 *
...
#define GFORCE_NR_IRQS	(IRQ_BOARD_START + 40)
...
static struct i2c_board_info __initdata cy8ctma340_i2c_devices[] = {
	{
		I2C_BOARD_INFO("cy8ctma340", 0x20),
...
static void regulator_init(void)
{
	...
	REG_INIT(i++, LDO5, 2900000, 2900000, 0, 0);
...
extern  void  gforce_lcd_init(void);
...
void gforce_pxa95x_abu_mfp_init(bool abu)
{
	if (abu)
...
static void __init init(void)
{
	...
	set_abu_init_func(gforce_pxa95x_abu_mfp_init);
...
*/
MACHINE_START(GFORCE_MG2, "PXA968 Handheld Platform (aka GFORCE)")
	.phys_io	= 0x40000000,
	.io_pg_offst	= (io_p2v(0x40000000) >> 18) & 0xfffc,
	.map_io         = pxa_map_io,
	.nr_irqs	= GFORCE_NR_IRQS,
