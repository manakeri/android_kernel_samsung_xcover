...
/* SAMSUNG_SMN: Moved from sec_debug.c */
enum sec_debug_upload_cause_t {
        ...
        UPLOAD_CAUSE_FORCED_CP_UPLOAD = 0x00000024,	/*SAMSUNG_SMN: Added for forced CP dump differenciation */
};

#define UPLOAD_CAUSE_ADDR 	0x8F2FFFFC	/* SAMSUNG_SMN: Added for upload cause */
