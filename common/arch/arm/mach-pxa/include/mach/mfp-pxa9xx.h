/*
 * arch/arm/mach-pxa/include/mach/mfp-pxa9xx.h
 *
 * PXA9xx specific MFP configuration definitions
 *
...
#define PMIC_INT_GPIO83		MFP_CFG(PMIC_INT, AF0)
#else
#define PMIC_INT_GPIO83		MFP_CFG_LPM(PMIC_INT, AF0, PULL_HIGH)/* pxa955 */
#endif
...
#define GPIO73_CI2C_SCL		MFP_CFG_LPM(GPIO73, AF1, PULL_HIGH)/* pxa955 */
#define GPIO74_CI2C_SDA		MFP_CFG_LPM(GPIO74, AF1, PULL_HIGH)/* pxa955 */
...
#define GPIO20_LCD_RST		MFP_CFG_LPM(GPIO20, AF0, PULL_HIGH)/* pxa955 */
#define GPIO93_LCD_CLK_TOUT	MFP_CFG_LPM(GPIO93, AF5, PULL_LOW)/* pxa955 */
...
/* pxa955 */
/* MMC3 */
#define GPIO88_MMC3_DAT1	MFP_CFG(GPIO88, AF1)
#define GPIO88_MMC3_DAT1_GPIO	MFP_CFG(GPIO88, AF0)
/* end of pxa955 */
...
/* pxa955 */
#define GPIO63_BSSP3_CLK	MFP_CFG(GPIO63, AF1)
#define GPIO64_BSSP3_FRM	MFP_CFG(GPIO64, AF1)
#define GPIO65_BSSP3_TXD	MFP_CFG(GPIO65, AF1)
#define GPIO66_BSSP3_RXD	MFP_CFG(GPIO66, AF1)
#define GPIO67_BSSP3_SYSCLK	MFP_CFG(GPIO67, AF1)

#define GPIO63_GSSP1_CLK	MFP_CFG(GPIO63, AF2)
#define GPIO64_GSSP1_FRM	MFP_CFG(GPIO64, AF2)
#define GPIO65_GSSP1_TXD	MFP_CFG(GPIO65, AF2)
#define GPIO66_GSSP1_RXD	MFP_CFG(GPIO66, AF2)
#define GPIO67_GSSP1_SYSCLK	MFP_CFG(GPIO67, AF2)

#define GPIO68_SSP2_RXD		MFP_CFG(GPIO68, AF1)
#define GPIO69_SSP2_TXD		MFP_CFG(GPIO69, AF1)
#define GPIO70_SSP2_SYSCLK	MFP_CFG(GPIO70, AF1)
#define GPIO71_SSP2_FRM		MFP_CFG(GPIO71, AF1)
#define GPIO72_SSP2_CLK		MFP_CFG(GPIO72, AF1)

#define GPIO68_ABU_RXD		MFP_CFG(GPIO68, AF2)
#define GPIO69_ABU_TXD		MFP_CFG(GPIO69, AF2)
#define GPIO71_ABU_FRM		MFP_CFG(GPIO71, AF2)
#define GPIO72_ABU_CLK		MFP_CFG(GPIO72, AF2)
#define GPIO45_SSP4_TXD		MFP_CFG_LPM(GPIO45, AF4, PULL_LOW)
#define GPIO51_SSP4_CLK		MFP_CFG_LPM(GPIO51, AF4, PULL_LOW)
#define GPIO52_SSP4_FRM		MFP_CFG_LPM(GPIO52, AF4, PULL_LOW)
/* end of pxa955 */
...
#define GPIO53_UART1_TXD	MFP_CFG(GPIO53, AF2)/* pxa955 */
#define GPIO54_UART1_RXD	MFP_CFG(GPIO54, AF2)/* pxa955 */
...
/* PXA970*/
#define GPIO80_MMC3_DAT1	MFP_CFG(GPIO80, AF1)

#define GPIO63_ABU_RXD          MFP_CFG(GPIO63, AF2)
#define GPIO64_ABU_TXD          MFP_CFG(GPIO64, AF2)
#define GPIO66_ABU_FRM          MFP_CFG(GPIO66, AF2)
#define GPIO67_ABU_CLK          MFP_CFG(GPIO67, AF2)

#define GPIO63_SSP2_RXD         MFP_CFG(GPIO63, AF1)
#define GPIO64_SSP2_TXD         MFP_CFG(GPIO64, AF1)
#define GPIO65_SSP2_SYSCLK      MFP_CFG(GPIO65, AF1)
#define GPIO66_SSP2_FRM         MFP_CFG(GPIO66, AF1)
#define GPIO67_SSP2_CLK         MFP_CFG(GPIO67, AF1)

#define GPIO58_BSSP3_CLK	MFP_CFG(GPIO58, AF1)
#define GPIO59_BSSP3_FRM	MFP_CFG(GPIO59, AF1)
#define GPIO60_BSSP3_TXD	MFP_CFG(GPIO60, AF1)
#define GPIO61_BSSP3_RXD	MFP_CFG(GPIO61, AF1)
#define GPIO62_BSSP3_SYSCLK	MFP_CFG(GPIO62, AF1)

#define GPIO58_GSSP1_CLK	MFP_CFG(GPIO58, AF2)
#define GPIO59_GSSP1_FRM	MFP_CFG(GPIO59, AF2)
#define GPIO60_GSSP1_TXD	MFP_CFG(GPIO60, AF2)
#define GPIO61_GSSP1_RXD	MFP_CFG(GPIO61, AF2)
#define GPIO62_GSSP1_SYSCLK	MFP_CFG(GPIO62, AF2)

#define GPIO94_UART3_RXD	MFP_CFG(GPIO94, AF1)
#define GPIO131_UART1_RXD	MFP_CFG(GPIO131, AF1)
