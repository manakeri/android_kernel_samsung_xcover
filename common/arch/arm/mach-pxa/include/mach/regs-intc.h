...
#define ICHP_OFFSET    0x18 /* from Interrupt Controller base */
#define IPR_0		__REG(0x40D0001C)  /* Interrupt Controller prio table [31..0] */
#define IPR_1		__REG(0x40D000B0)  /* Interrupt Controller prio table [63..32] */
#define IPR_2		__REG(0x40D00144)  /* Interrupt Controller prio table [95..64] */
