...
#define GPIO171_GPIO171		MFP_CFG(GPIO171, AF0)
...
/* Ethernet */
#define GPIO154_SM_ADVMUX	MFP_CFG(GPIO154, AF2)
...
/*MMC3, MMP3 A step*/
#define GPIO161_MMC3_DAT7	MFP_CFG_DRV(GPIO161, AF2, FAST)	/* aka NDIO12 */
#define GPIO145_MMC3_DAT6	MFP_CFG_DRV(GPIO145, AF2, FAST)	/* aka SMnCS0 */
#define GPIO162_MMC3_DAT5	MFP_CFG_DRV(GPIO162, AF2, FAST)	/* aka NDIO11 */
#define GPIO146_MMC3_DAT4	MFP_CFG_DRV(GPIO146, AF2, FAST)	/* aka SMnCS1 */
#define GPIO163_MMC3_DAT3	MFP_CFG_DRV(GPIO163, AF2, FAST)	/* aka NDIO10 */
#define GPIO108_MMC3_DAT2	MFP_CFG_DRV(GPIO108, AF2, FAST)	/* aka NDIO15 */
#define GPIO164_MMC3_DAT1	MFP_CFG_DRV(GPIO164, AF2, FAST)	/* aka NDIO09 */
#define GPIO109_MMC3_DAT0	MFP_CFG_DRV(GPIO109, AF2, FAST)	/* aka NDIO14 */
#define GPIO111_MMC3_CMD	MFP_CFG_DRV(GPIO111, AF2, FAST)	/* aka NDIO08 */
#define GPIO110_MMC3_CLK	MFP_CFG_DRV(GPIO110, AF2, FAST)	/* aka NDIO13 */
...
#define GPIO135_LCD_RST		MFP_CFG_DRV(GPIO135, AF0, FAST) /* MMP3 */
...
#define GPIO96_HSIC_RESET	MFP_CFG_X(GPIO96, AF0, MEDIUM, DRIVE_LOW)
