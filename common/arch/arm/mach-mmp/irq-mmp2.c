...
#ifdef CONFIG_PM
	icu_irq_chip.set_wake = mmp2_set_wake;
	pmic_irq_chip.set_wake = mmp2_set_wake;
	rtc_irq_chip.set_wake = mmp2_set_wake;
	keypad_irq_chip.set_wake = mmp2_set_wake;
	twsi_irq_chip.set_wake = mmp2_set_wake;
	misc_irq_chip.set_wake = mmp2_set_wake;
	hsi1_irq_chip.set_wake = mmp2_set_wake;
	hsi0_irq_chip.set_wake = mmp2_set_wake;
#endif	/* CONFIG_PM */
}
